...
public final class MenuBinding implements ViewBinding {
  ...
  @NonNull
  public final Button buttonDSSinhVien;

  @NonNull
  public final Button buttonQuet;

  private MenuBinding(@NonNull ConstraintLayout rootView, @NonNull Button buttonDSSinhVien,
      @NonNull Button buttonQuet) {
    this.rootView = rootView;
    this.buttonDSSinhVien = buttonDSSinhVien;
  ...
  public static MenuBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.button_DS_Sinh_Vien;
      Button buttonDSSinhVien = ViewBindings.findChildViewById(rootView, id);
      if (buttonDSSinhVien == null) {
        break missingId;
      }
      ...
      return new MenuBinding((ConstraintLayout) rootView, buttonDSSinhVien, buttonQuet);
    }
